...
public class FlowControllerV1 {
    ...
    public Result<List<FlowRuleEntity>> apiQueryMachineRules(@RequestParam String app,
        ...
        try {
            List<FlowRuleEntity> allRule = ruleProvider.getRules(app);
            List<FlowRuleEntity> rules = allRule.stream().filter(e->ip.equals(e.getIp())&&port.equals(e.getPort())).collect(
                    Collectors.toList());
            repository.saveAll(allRule);
